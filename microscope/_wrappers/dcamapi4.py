...
class PROPMODEVALUE(enum.IntEnum):
    ...
    TIMING_EXPOSURE__AFTERREADOUT = 1
    TIMING_EXPOSURE__OVERLAPREADOUT = 2
    TIMING_EXPOSURE__ROLLING = 3
    TIMING_EXPOSURE__ALWAYS = 4
    TIMING_EXPOSURE__TDI = 5
