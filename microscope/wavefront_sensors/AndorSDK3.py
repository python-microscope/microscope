...
if plat.startswith('Windows'):
    if arch == '32bit':
        _stdcall_libraries['ATCORE'] = ctypes.WinDLL('C:/Program Files/Andor SDK3/atcore')
        _stdcall_libraries['ATUTIL'] = ctypes.WinDLL('C:/Program Files/Andor SDK3/atutility')
    else:
        _stdcall_libraries['ATCORE'] = ctypes.OleDLL('C:/Program Files/Andor SDK3/atcore')
        _stdcall_libraries['ATUTIL'] = ctypes.OleDLL('C:/Program Files/Andor SDK3/atutility')
else:
